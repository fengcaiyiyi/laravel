...
<div id="wrapper">
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li>
                    <a class="J_menuItem" href=""><i class="fa fa-columns"></i> <span
                                class="nav-label">分类管理</span></a>
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="{{ URL::route('feimo/category') }}">分类列表</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="{{ URL::route('feimo/addCategory') }}">添加分类</a>
                        </li>
                ...
                <li>
                    <a href="#"><i class="fa fa-edit"></i> <span class="nav-label">文章管理</span><span
                                class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        <li><a class="J_menuItem" href="{{ URL::route('feimo/addArticle') }}">新增文章</a>
                        </li>
                    </ul>
                </li>
                <li>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row J_mainContent" id="content-main">
            <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="{{ URL::route('feimo/main') }}" frameborder="0"
